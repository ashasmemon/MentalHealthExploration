...
Upon further examining of literature about the gender gap is depression, women are twice as likely to depression as compared to men [@GenderGap]

## Race

Hispanic and black communities still view depression as a taboo topic and are less likely to report those cases if the are asked. Culturally, they don't believe that depression is a disorder so they dont admit it. could also be that there are significantly less hispanic and black individusuals living in California so that why there are less cases.

## Age

# Privacy and Ethics 

Data collected anonymously, data collection about racial backfround and other factors including age,sex but not any personal information to link the data back to any of the surveyed individuals.
